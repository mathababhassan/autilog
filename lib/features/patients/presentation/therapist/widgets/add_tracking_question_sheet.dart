...
class AddTrackingQuestionSheet extends StatefulWidget {
  final String parentId;
  final String childId;
  final String childName;

  const AddTrackingQuestionSheet({
    super.key,
  ...
  @override
  State<AddTrackingQuestionSheet> createState() => _AddTrackingQuestionSheetState();
}

class _AddTrackingQuestionSheetState extends State<AddTrackingQuestionSheet> {
  final _textController = TextEditingController();
  final _formKey = GlobalKey<FormState>();
  String _selectedAnswerType = 'yes_no';
  bool _saving = false;
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'This question will appear in the parent\'s next daily summary.',
                        style: AppTextStyles.caption.copyWith(
